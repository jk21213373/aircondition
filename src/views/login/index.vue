...
const login = async () => {
    ...
    try {
        ...
        try {
            ...
            // if (!redirect.meta.type.includes(String(useStore.type))) redirect = routes[Number(useStore.type) - 1];
            // console.log(999999999999999999977777777777777777777777777777777777777777);
            // console.log(redirect.meta.type);
