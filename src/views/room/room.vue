<template>
    <el-card style="height:80px;">
        <el-form :inline="true" class="form">
            ...
            <el-form-item>
                <el-button class="btn" type="primary" size="default" @click="getRoom"><span>搜索</span></el-button>
    ...
    <el-card style="margin:10px 0px;">
        ...
        <el-table style="font-size:12px; margin:10px 0px;border" :data="rooms" @selection-change="updateTable">
            ...
            <el-table-column width="40" label="#" align="center" type="index"></el-table-column>
            <el-table-column width="40" label="ID" align="center" prop="id"></el-table-column>
            <el-table-column width="50" label="楼层ID" align="center" prop="storeyId"
                show-overflow-tooltip></el-table-column>
            <el-table-column width="60" label="房间名称" align="center" prop="name" show-overflow-tooltip></el-table-column>
            <el-table-column width="60" label="房间面积" align="center" prop="area" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column label="操作" width="160px" align="center">
                <template #="{ row, $index }">
                    <!-- <el-button class="btn1" type="primary" size="small" @click="checkRoom(row)">
                        <el-icon style="color:#555666">
                            <View />
                        </el-icon>
                        <span>查看房间</span></el-button> -->
                    <!-- <el-button class="btn1" type="primary" @click="checkRoom(row)">
                        <el-icon style="color: #555666;">
                                    <Delete />
                                </el-icon>
                        <el-icon style="color: #555666">
                        ...
                        <span class="show">查看房间</span></el-button> -->
                    <!-- <el-button class="btn1" type="primary" size="small" @click="checkRoom(row)">
                        <el-icon :style="{ color: '#555666' }">
                            <View />
                        </el-icon> <span class="show">查看房间</span></el-button> -->
    ...
    <el-drawer v-model="drawer">
        ...
        <el-form :model="roomParams" :rules="rules" ref="formRef">
            ...
            <el-form-item label="节假日开空调时间" prop="holidayStarttime">
                <!-- <el-input placeholder="请您输入节假日开空调时间" v-model="roomParams.holidayStarttime"></el-input> -->
            ...
            <el-form-item label="节假日关空调时间" prop="holidayEndtime">
                <!-- <el-input placeholder="请您输入节假日开空调时间" v-model="roomParams.holidayEndtime"></el-input> -->
            ...
            <el-form-item label="工作日开空调时间" prop="workdayStarttime">
                <!-- <el-input placeholder="请您输入工作日开空调时间" v-model="roomParams.workdayStarttime"></el-input> -->
            ...
            <el-form-item label="工作日关空调时间" prop="workdayEndtime">
                <!-- <el-input placeholder="请您输入工作日开空调时间" v-model="roomParams.workdayEndtime"></el-input> -->
...
const rules = {
    ...
    holidayStarttime: [
        ...
        // { type: 'date', message: '请选择一个时间', trigger: 'blur' },
    ],
    holidayEndtime: [
