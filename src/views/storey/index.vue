<template>
    <el-card style="margin:10px 0px;">
        ...
        <el-popconfirm :title="`你确定要删除?`" width="260px" @confirm="AlldeleteStorey()">
            <template #reference>
                <el-button class="btn" type="primary'" size="default"><span>批量删除</span></el-button>
            </template>
        </el-popconfirm>
    ...
    <el-drawer v-model="drawer">
        ...
        <el-form :model="storeyParams" :rules="rules" ref="formRef">
            <el-form-item label="楼层名称" prop="name">
                <el-input placeholder="请您输入房间名称" v-model="storeyParams.name"></el-input>
            </el-form-item>
        </el-form>
        I<template #footer>
            <div>
...
import { reqGetStroey, reqDeleteStorey, reqAddStorey } from '@/api/acl/storey'
